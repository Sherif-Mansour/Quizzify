       ...
       <View style={styles.body}>
          <Text style={styles.text}>
           "Welcome to Quizzifiy! - the ultimate destination for trivia
            enthusiasts! Embark on a thrilling journey of knowledge and entertainment with
            our diverse range of quizzes covering a wide array of topics. From history and geography to music
            and sports. With Quizzifiy, learning is fun and engaging, making it the perfect companion for both 
            casual gamers and avid learners. Get ready to quiz, learn and repeat with Quizzifiy! - where knowledge 
            meets excitement!"
          </Text>
          
      <View style={styles.paragraphContainer}>
        <Text style={styles.triviaHeaderText}>
          Trivia of the day:
        </Text>
